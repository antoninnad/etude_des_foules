    ...
    tab.append(
        {
            ...
            "masse": 10,
            "vitesse_desiree": 2 + random.randint(-1, 1) * random.randint(0, 25) * 0.01,
            "vitesse": np.array([0, 0]),
            "tau": 0.2,
            "rayon": 12,
        }
            ...
            tab.append(
                {
                    "id": y * 6 + x + 1,
                    "position": np.array(
                        [120 + (70 * x) + x_colunm_seperator, 260 + (71 * y)]
                    ),
                    "destination": np.array(
                        [120 + (70 * x) + x_colunm_seperator, 260 + (71 * y)]
                    ),
                    "masse": 10,
                    "vitesse_desiree": 2 + random.randint(0, 25) * 0.1,
                    "vitesse": np.array([0, 0]),
                    "tau": 0.2,
                    "rayon": 10 + random.randint(-2, 2),
                }
...
class app:
    def __init__(self):
        ...
        self.explication_sim = tk.Label(
            self.root, text="Simulation à lancer :", font=("Arial", 14), bg="#e8e8e8"
        )
        ...
        self.button = tk.Button(
            self.root,
            text="Commencer simulation basique",
            width=27,
            command=self.start_basique,
            bg="#e8e8e8",
        )
        ...
        self.explication_mode = tk.Label(
            self.root,
            text="Mode de résolution des équations de vitesses :",
            font=("Arial", 14),
            bg="#e8e8e8",
        )
        ...
        self.particule = tk.Label(
            self.root, text=f"Personnes ", bg="white", fg="black", font=("Arial", 14)
        )
        self.temps = tk.Label(
            self.root, text="Temps 0.0 s", bg="white", fg="black", font=("Arial", 14)
        )
        ...
        self.slider = tk.Scale(
            ...
            orient="horizontal",
            length=200,
            command=self.augmenter_vitesse,
            bg="#e8e8e8",
        )
    ...
    def start(self):
        ...
        if self.dev:
            ...
            fichier_coords = open(fileName, "w")
